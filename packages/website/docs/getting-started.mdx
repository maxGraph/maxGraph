...
`maxGraph` is licensed under the [Apache 2.0](https://www.apache.org/licenses/LICENSE-2.0.html) license and it sources are available in the [maxGraph GitHub repository](https://github.com/maxGraph/maxGraph).
