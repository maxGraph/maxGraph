...
// TODO verify this is the version of the method that was removed
- methods used to compute style values (with fallback to default values) have been removed in 0.15.0. Use the [nullish coalescing operator (??)](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Operators/Nullish_coalescing)
