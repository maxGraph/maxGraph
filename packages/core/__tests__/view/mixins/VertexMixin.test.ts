...
const expectCellInModel = (graph: Graph, expectedCell: Cell, cellId: string) => {
  const cellFromModel = graph.getDataModel().getCell(cellId);
...
describe('insertVertex', () => {
  describe('with several parameters', () => {
    test('with position, size and style', () => {
      ...
      expectCellInModel(graph, cell, cellId);
    });
  ...
  describe('with single parameter', () => {
    ...
    test('with position, size and style', () => {
      ...
      expectIsChildOfDefaultParent(cell);
      expectCellInModel(graph, cell, autoGeneratedCellId);
    });
    ...
    test('with non default parent', () => {
      ...
      expect(parentCell.getId()).toBe(autoGeneratedCellId);
