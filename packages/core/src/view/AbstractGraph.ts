...
// TODO review the name: GraphOptions for simplicity?
...
} & CollaboratorsGraphOptions;

// TODO generalize usage of collaborators, see https://github.com/maxGraph/maxGraph/discussions/151
export type CollaboratorsGraphOptions = {
  cellRenderer?: CellRenderer;
  model?: GraphDataModel;
  // TODO do not allow null for simplification, in Graph constructor, set to undefined if null is passed
  stylesheet?: Stylesheet | null; // allow null because the Graph constructor allows null values
  // TODO potential cycle
  view?: (graph: AbstractGraph) => GraphView;
};

// TODO in all JSDoc replace Graph by AbstractGraph
...
export abstract class AbstractGraph extends EventSource {
  ...
  // TODO review the name of this method, explain purpose
  // register defaults transparently, global defaults can also be registered outside of this class
  protected registerDefaults(): void {
    // do nothing, this is the purpose of this class not to load any defaults
  }

  protected abstract initializeCollaborators(options: CollaboratorsGraphOptions): void;

  // TODO decide if we manage undefined options with "options: BaseGraphOptions = {}"
  // This will be needed to manage https://github.com/maxGraph/maxGraph/issues/367
  constructor(options: BaseGraphOptions) {
    super();
