...
export type FitOptions = {
  /**
   * Optional number that specifies the border. @default{@link Graph.getBorder}.
   */
  border?: number;
  /**
   * Optional boolean that specifies if the "translate" should be changed. @default`false`.
   */
  keepOrigin?: boolean;
  /**
