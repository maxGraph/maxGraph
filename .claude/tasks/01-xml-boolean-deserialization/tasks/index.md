...
- [ ] **Task 10**: Flip the expectations and land the decode fix, `task-10.md` (needs 07, 08, 09)
- [ ] **Task 11**: Align the two encoders that emit the words true and false onto 1 and 0, `task-11.md` (needs 09)
