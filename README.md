...
maxGraph is under active development. An alpha version will be released soon with the npm package once [licensing](https://github.com/maxGraph/maxGraph/issues/89)
